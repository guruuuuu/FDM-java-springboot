...
public class BookController {
	...
	public String register(@RequestParam String title, @RequestParam String email, @RequestParam double price,
			ModelMap map) {
	...
	public String updateBook(@RequestParam Long id, ModelMap map) {
		Book foundBook = this.bookService.findById(id);
		map.addAttribute("book", foundBook);
		return "edit-book";
	}

	@PostMapping("/edit")
	public String updateBook(@RequestParam Long id, @RequestParam String title, @RequestParam String author, @RequestParam double price, ModelMap map) {
