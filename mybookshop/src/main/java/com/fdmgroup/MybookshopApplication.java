...
public class MybookshopApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Book book2 = new Book("SpringFramwork Introduction", 20.99);
		
		Author author = new Author("Jhoe Doe", "jd@msn.com", "11111");
		Author author1 = new Author("Mesut Cem", "mesut@gmail.com", "11111");
